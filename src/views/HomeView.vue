  ...
  <div class="min-h-screen">
    ...
    <section class="relative overflow-hidden py-16 lg:py-24">
      ...
      <div class="absolute inset-0 -z-10">
        ...
        <div class="absolute bottom-0 right-1/4 w-80 h-80 bg-amber-600/6 rounded-full blur-3xl"></div>
      </div>
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
          ...
          <div class="flex flex-wrap justify-center gap-6 animate-fade-in-up">
            ...
            <div class="glass px-6 py-4 rounded-xl">
              <div class="flex items-center space-x-3">
                <div class="w-10 h-10 bg-gradient-to-br from-stone-600 to-stone-700 rounded-lg flex items-center justify-center">
                  <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between mb-10 gap-6">
          ...
          <div class="flex flex-col sm:flex-row gap-3 animate-fade-in-up">
            ...
            <div class="relative">
              ...
              >
              <svg class="w-4 h-4 text-stone-400 absolute left-3 top-1/2 transform -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
