  ...
  <article class="card-blog animate-fade-in-up">
    <div class="flex items-start justify-between mb-5">
      <div class="flex-1">
        <div class="flex items-center space-x-3 mb-3">
          <div
            class="w-8 h-8 bg-gradient-to-br from-amber-600 to-amber-700 rounded-lg flex items-center justify-center"
          >
          ...
          <div class="flex-1 min-w-0">
            <div class="flex items-center space-x-2 mb-1">
              ...
              <div
                v-if="post.pinned"
                class="flex-shrink-0 p-1 bg-amber-100 rounded-full"
                title="Bài viết ghim"
              >
    ...
    <div class="flex items-center justify-between pt-4 border-t border-stone-100">
      <div class="flex flex-wrap gap-2">
        ...
        <span v-if="post.tags.length > 3" class="text-xs text-stone-400 font-medium">
